			...
			<div class="box box-info">
				<div class="box-body">
					...
					<form action="{{ route('page_setting.store') }}" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
						...
						<h3 class="sec_title">Our location</h3>
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Title</label>
							<div class="col-sm-6">
								<input type="text" name="location_title" class="form-control" value="{{ isset($page_data['location_title'])?$page_data['location_title']:'' }}" placeholder="Enter Title">
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Meta Keyword</label>
							<div class="col-sm-6">
								<input type="text" name="location_keyword" class="form-control" value="{{ isset($page_data['location_keyword'])?$page_data['location_keyword']:'' }}" placeholder="Enter Keyword">
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Description</label>
							<div class="col-sm-9">
								<textarea class="form-control" name="location_description" style="height:60px;" placeholder="Enter Description">{{ isset($page_data['location_description'])?$page_data['location_description']:'' }}</textarea>
							</div>
						</div>
						<div class="form-group">
